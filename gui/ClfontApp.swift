...
let releaseNotes: [ReleaseNote] = [
    ReleaseNote(
        ...
        en: [
            ...
            "Added a page background, which brings back the cream tone of earlier Claude versions. Three presets, or pick your own colour. Light mode only, so dark mode is untouched. Look under Appearance.",
